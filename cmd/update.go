...
const repoURL = "https://github.com/the20100/gads-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update gads-cli to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "gads-cli-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "gads-cli")
